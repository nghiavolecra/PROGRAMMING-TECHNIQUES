...
protected:
    ...
    ItemType item_type; //! khác biến này do sinh  viên tự thiết kế tạo test không đc đụng tới
...
public:
    ...
    ItemType getItem() { return item_type; } //! khác biến này do sinh  viên tự thiết kế tạo test không đc đụng tới

    int dominantDigitSum(int n);
    // ~Robot(); de sau
};
...
public:
    ...
    bool containsItemType(ItemType typeName) const;
};
// addition
